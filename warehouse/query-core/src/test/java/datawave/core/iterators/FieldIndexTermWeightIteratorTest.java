...
public class FieldIndexTermWeightIteratorTest {
    ...
    public void testFullScanRange_singleKey_first() throws IOException {
        Key start = new Key("20200314_0", "fi\u0000FIELD_A" , "datatype\0uid0");
        Key end = new Key("20200314_0", "fi\u0000FIELD_A", "datatype\0uid9.9\uffff");
        Range r = new Range(start, false, end, true);
    ...
    public void testGetNextSeekRange() throws IOException {
        ...
        Key start = getFiKey("row", "type1", "123.345.456", "FIELD_A", "value_c");
        Key end = getFiKey("row", "type1", "123.345.456.1", "FIELD_A", "value_d");
            ...
            for (int jj = 0; jj < 10; jj++) {
                for (int lower = 0; lower < lowers.length(); lower++) {
                    for (int upper = 0; upper < uppers.length(); upper++) {
                        ...
                        Text cq = new Text(value + NULL + "datatype\0" + uid);
                        
                        Key k = new Key(row, new Text("fi" + NULL + field), cq);
    ...
    public SortedListKeyValueIterator buildIterAcrossValuesWithNulls() {
        ...
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456", "FIELD_A", "value_a"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456", "FIELD_A", "value_b"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456", "FIELD_A", "value_c"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456", "FIELD_A", "val\0ue_d"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456.1", "FIELD_A", "value_a"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456.1", "FIELD_A", "value_b"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456.1", "FIELD_A", "val\0ue_c"), new Value()));
        baseSource.add(new SimpleEntry(getFiKey("row", "type1", "123.345.456.1", "FIELD_A", "value_d"), new Value()));
    ...
    private Key getFiKey(String row, String dataType, String uid, String fieldName, String fieldValue) {
        return new Key(row, "fi" + NULL + fieldName, fieldValue + NULL + dataType + NULL + uid );
    }
