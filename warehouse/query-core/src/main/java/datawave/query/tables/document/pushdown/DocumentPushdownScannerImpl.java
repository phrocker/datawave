...
public class DocumentPushdownScannerImpl extends ScannerOptions implements BatchScanner {
    private static final Logger log = LoggerFactory.getLogger(DocumentPushdownScannerImpl.class);
    ...
    public DocumentPushdownScannerImpl(ClientContext context, TableId tableId,
    ...
    public Iterator<Document> getDocumentIterator() {
        ...
        return new DocumentPushdownScan(context, tableId, authorizations, ranges,
