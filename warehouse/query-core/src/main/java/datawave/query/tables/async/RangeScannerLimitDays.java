...
public class RangeScannerLimitDays extends RangeStreamScanner {
     ...
     * @param maxResults
     */
    public RangeScannerLimitDays(String tableName, Set<Authorizations> auths, ResourceQueue delegator, int maxResults, Query settings, SessionOptions options,
                              Collection<Range> ranges) {
        super(tableName, auths, delegator, maxResults, settings, options, ranges);
    }

    public RangeScannerLimitDays(ScannerSession other) {
        super(other);
    }
