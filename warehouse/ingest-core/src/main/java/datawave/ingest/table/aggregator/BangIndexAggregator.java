 ...
 */
public class BangIndexAggregator extends PropogatingCombiner {
    private static final Logger log = LoggerFactory.getLogger(BangIndexAggregator.class);
    private static final String TIMESTAMPS_IGNORED = "timestampsIgnored";
    private static final String MAX_UID_COUNT = "maxUidCount";
    ...
    public BangIndexAggregator(int max) {
        this.maxUids = max;
    }

    public BangIndexAggregator() {
        this.maxUids = MAX;
    }
    ...
    public boolean validateOptions(Map<String,String> options) {
        ...
        if (valid) {
            ...
            if (options.containsKey(MAX_UID_COUNT)) {
                maxUids = Integer.valueOf(options.get(MAX_UID_COUNT));
            }
        }
        return valid;
    }
    ...
    public SortedKeyValueIterator<Key,Value> deepCopy(IteratorEnvironment env) {
        BangIndexAggregator copy = (BangIndexAggregator) super.deepCopy(env);
